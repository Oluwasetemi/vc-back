...
import { outfitRequestEventsData, stylistRequestEventsData } from './EventsTableData';
        ...
        <Wrapper>
            <Paper className="request-paper">
                ...
                <TabPanel value={value} index={3}>
                    <SortTablePagination rows={stylistRequestEventsData} headCells={headCells2} />
                </TabPanel>
                <TabPanel value={value} index={4}>
                    <SortTablePagination rows={outfitRequestEventsData} headCells={headCells2} />
                </TabPanel>
