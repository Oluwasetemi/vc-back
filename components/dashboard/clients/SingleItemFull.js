						...
						<div className="list grid">
							...
							<p className="text bold">
								{loading
									...
									: error
									? 'no data'
									: data.fetchOneItemUser.category}
							</p>
						</div>
						<div className="list grid">
							...
							<p className="text bold">
								{loading
									...
									: (data.fetchOneItemUser.pickup &&
											data.fetchOneItemUser.pickup.datetimePicked.substring(
												0,
												10,
											)) ||
									  'none'}
