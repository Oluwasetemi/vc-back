      ...
      <DashboardLayout>
        ...
        <div className="grid">
          ...
          <div className="grid-item">
            ...
            <div className="content">
              <div className="item first flex"><p>Additional shoes (Platinum & Gold)</p> <p className='bold'>$3</p></div>
              <div className="item  flex"><p>Accessories (Ties, scarves, 
purses, etc)</p> <p className='bold'>$1</p></div>
              <div className="item  flex"><p>Help me pack</p> <p className='bold'>$50</p></div>
