                ...
                <UserDetailCard
                        ...
                        <>
                            ...
                            <div className="rhs">
                                <div className="list grid first">
                                    ...
                                    <p className="text bold">{loading ? 'loading' : userById.phone}</p>
                                </div>
                                ...
                                <div className="list grid">
                                    ...
                                    <p className="text bold">
                                        {loading ? 'loading' : userById.closet && userById.closet.items.length}
                                    </p>
                                </div>
                                <div className="list grid">
                                    <p className="text">Items in vault</p>
                                    <p className="text bold">{loading ? 'loading' : 'coming soon'}</p>
                                </div>
                                <div className="list grid">
                                    <p className="text">Requests</p>
                                    <p className="text bold">
                                        {loading ? 'loading' : error ? 'no item' : userById.requests.length}
                                    </p>
                                </div>
                            </div>
                            <div className="rhs">
                                <div className="list grid first">
                                    ...
                                    <p className="text bold">{loading ? 'loading' : userById.email}</p>
                                </div>
                                <div className="list grid">
                                    <p className="text">Outfits</p>
                                    <p className="text bold">
                                        {loading ? 'loading' : error ? 'no item' : userById.outfit.length}
                                    </p>
                                </div>
                                <div className="list grid">
                                    <p className="text">Designs</p>
                                    <p className="text bold">{loading ? 'loading' : 'no items'}</p>
                                </div>
                                <div className="list grid">
                    ...
                    buttons={
                        <>
                            ...
                            <Link href={{ pathname: '/clients/paymenthistory', query: { id } }}>
