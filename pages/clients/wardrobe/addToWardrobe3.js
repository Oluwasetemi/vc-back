  ...
  return (
    <Wrapper>
      <DashboardLayout>
        ...
        <h3 className="title">Add to Wardrobe</h3>
		...
		<div className="flex wrap"><h1>Items</h1>
		  ...
		  <Link href="/clients/wardrobe/addToWardrobe2">
				  ...
				  <p className="info name text">Add single or multiple items to the wardrobe  <Link href="#"><span>Add Image</span></Link></p>
