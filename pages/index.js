                ...
                <div className="main">
                    <div className="hero">
                        <div className="lhs">
                            ...
                            <p className="info">
                                A world where limitations between your clothing
                                choices and wardrobe do not exist.
                            </p>
                    ...
                    <div className="what_we_do">
                        ...
                        <div className=" grid">
                            <div className="what gridy">
                                ...
                                <p className="detail">
                                    Your clothing items are stored at our
                                    climate controlled warehouses and available
                                    on demand.
                                </p>
                            </div>
                            <div className="what gridy">
                                ...
                                <p className="detail">
                                    Work, social, formal, dinner, cocktail. No
                                    matter the event, we have got you covered.
                                </p>
                            </div>
                            <div className="what gridy">
                                ...
                                <p className="detail">
                                    Preserve your heirlooms and valuables at our
                                    secure locations, and access them when you
                                    need them.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="platinum gridy">
                                ...
                                <div className="packages">
                                    ...
                                    <div className="package flex">
                                        ...
                                        <p>
                                            Access to secure vault for valuables
                                        </p>
                                    </div>
                                    <div className="package flex">
                                        <img src={hanger} alt="hanger" />
                                    ...
                                    <img
                                        className="absolute"
                                        src={platinum_wardrobe}
                                        alt="platinum_wardrobe"
                                    />
                                </div>
                            </div>
                        </div>
