...
const sendPickup = (props) => {
  ...
  return (
    <Wrapper>
      <DashboardLayout>
        ...
        <Paper className="paper paper-top">
          <TabPanel value={value} index={0}>
            <div className="flex paper-top-head wrap">
              ...
              <div className="buttons flex wrap">
                ...
                <p className="accept red" onClick={() => setValue(1)}>Start Checkout</p>
              </div>
            </div>
          </TabPanel>
          <TabPanel value={value} index={1}>
            <div className="flex paper-top-head wrap">
              ...
              <div className="buttons flex wrap">
                ...
                <p className="accept pink" >
                  {" "}
                  Reschedule
                </p>

                <p className="accept red" onClick={() => setValue(2)}>Proceed To Checkout</p>
              </div>
            </div>
          </TabPanel>
          <TabPanel value={value} index={2}>
            <div className="flex paper-top-head wrap">
              ...
              <div className="buttons flex wrap">
                ...
                <p className="accept red" onClick={() => setValue(3)}>Delivery Complete</p>
              </div>
            </div>
          </TabPanel>
          ...
          <div className="tabset">
            ...
            <TabPanel className="tabpanel1" value={value} index={0}>
              ...
              proceeding will set the pickup as active. Please click “Start Checkout” to continue.
            </TabPanel>
          </div>
        </Paper>
		...
		<UserDetailCard top={<p className="date">Monday, June 2, 2020</p>
          ...
          <p className="pink">View Client</p></Link>}  weight="date mb-70" text="You’re checking items out of storage"/>
    ...
    <p className="pink">View Client</p></Link>}  weight="date mb-70" text="You can start checkout of the customer today"/>
...
<div className="checked absolute">
          < CheckboxInput/>
        </div>                <div className="image image1"></div>
              </div>
              <p className="name text">Plain black shirt</p>
              <p className="id text">ID: 2342323</p>
            </div>
...
<div className="checked absolute">
          < CheckboxInput/>
        </div>                <div className="image image2"></div>
              </div>
              <p className="name text">Plain black shirt</p>
              <p className="id text">ID: 2342323</p>
            </div>
