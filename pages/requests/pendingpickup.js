    ...
    return (
        <Wrapper>
            <DashboardLayout>
                ...
                <UserDetailCard
                    userName={loading ? 'loading' : error ? 'no data' : singleRequest.user.email}
                    userId={loading ? 'loading' : error ? 'no data' : singleRequest.user._id.substring(0, 7)}
                    top={
                        <>
                            <p className="date">
                                {loading
                                    ...
                                    : error
                                    ? 'no data'
                                    : format(new Date(singleRequest && singleRequest.datetimePicked), 'PPPP')}
                            </p>
                        ...
                        <>
                            ...
                            <div className="rhs">
                                <div className="list grid first">
                                    ...
                                    <p className="text bold">
                                        {loading ? 'loading' : error ? 'no data' : singleRequest.numberOfItems}
                                    </p>
                                </div>
                                <div className="list grid">
                                    <p className="text">Type</p>
                                    <p className="text bold">
                                        {loading ? 'loading' : error ? 'no data' : singleRequest.type}
                                    </p>
                                </div>
                                <div className="list grid">
                            ...
                            <div className="rhs">
                                ...
                                <div className="list grid">
                                    ...
                                    <p className="text bold">
                                        {loading ? 'loading' : error ? 'no data' : singleRequest.contactPhoneNumber}
                                    </p>
                                </div>
                                <div className="list grid">
                    ...
                    buttons={
                        <Link
                            href={{
                                ...
                                query: {
                                    id: `${loading ? 'loading' : error ? 'no data' : singleRequest.user._id}`,
                                },
                            }}
                        >
